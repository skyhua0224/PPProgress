...
- ProjectPrinting:
  - [undefined] [backend] 自动合并[c49c944: feat: 添加批量获取打印任务详情的支持，优化订单信息查询]\n
- backend:
  - [undefined] feat: 添加批量获取打印任务详情的支持，优化订单信息查询
