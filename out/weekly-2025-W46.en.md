...
- ProjectPrinting:
  - [undefined] [backend] 自动合并[1845a5c: feat: 添加全局打印任务状态流功能，支持实时更新和监控]\n
- backend:
  - [undefined] feat: 添加全局打印任务状态流功能，支持实时更新和监控
