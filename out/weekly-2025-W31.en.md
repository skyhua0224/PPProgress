...
- backend:
  ...
  - [undefined] refactor: 在MenuManageServiceImpl中添加只读事务注解以提高性能；在getMenuTreeForManagement方法中预先初始化权限以避免LazyInitializationException
