...
- ProjectPrinting:
  - [undefined] [backend] 自动合并[3b6ec23: feat: 在打印作业进度中添加当前文件名的设置逻辑]\n
- backend:
  - [undefined] feat: 在打印作业进度中添加当前文件名的设置逻辑
