...
- ProjectPrinting:
  - [undefined] [backend] 自动合并[3dac315: feat: 更新打印作业监控流和状态响应，添加进度和副本信息]\n
- backend:
  - [undefined] feat: 更新打印作业监控流和状态响应，添加进度和副本信息
